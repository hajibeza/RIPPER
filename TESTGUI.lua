...
if game.CoreGui:FindFirstChild(Name_HUB .. "," .. HUB_VERSION) then
    game.CoreGui:FindFirstChild(Name_HUB .. "," .. HUB_VERSION):Destroy()
end
...
MIDNPaid.Name = Name_HUB .. "," .. HUB_VERSION
...
function MIDN:Window(text)
    ...
    MinimizeBtn.Text = ""
    MinimizeBtn.TextColor3 = Color_UI
    ...
    CloseSettingsBtnCircle.BackgroundColor3 = Color_UI
    ...
    CloseSettingsBtnIcon.BackgroundColor3 = Color_UI
    ...
    UserPanelUserIcon.MouseButton1Click:Connect(
        function()
            ...
            NotificationHolder.TextColor3 = Color_UI
    ...
    function MIDN:Notification(titletext, desctext, btntext)
        ...
        AlrightBtn.TextColor3 = Color_UI
    ...
    function ServerHold:Server(text, LoadImage)
        ...
        ServerTitle.TextColor3 = Color_UI
        ...
        ChannelTitle.Text = ""
        ChannelTitle.TextColor3 = Color_UI
        ...
        function ChannelHold:Channel(text)
            ...
            function ChannelContent:Toggle(text, default, callback)
                ...
                ToggleTitle.TextColor3 = Color_UI
                    ...
                    function()
                        if toggled == false then
                            TweenService:Create(
                                Icon,
                                TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                                {ImageColor3 = Color_UI}
                            ):Play()
                            TweenService:Create(
                                ToggleFrame,
                                TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                                {BackgroundColor3 = Color_UI}
                            ):Play()
            ...
            function ChannelContent:Slider(text, min, max, start, callback)
                ...
                SliderTitle.TextColor3 = Color_UI
                ...
                CurrentValueFrame.BackgroundColor3 = Color_UI
            ...
            function ChannelContent:Dropdown(text, list, callback)
                ...
                DropdownTitle.TextColor3 = Color_UI
                ...
                CurrentSelectedText.TextColor3 = Color_UI
                ...
                DropdownFrameBtn.TextColor3 = Color_UI
                ...
                DropItemHolderLabel.TextColor3 = Color_UI
                ...
                DropItemHolder.ScrollBarImageColor3 = Color_UI
            ...
            function ChannelContent:Texbox(text, placetext, disapper, callback)
                ...
                TextboxTitle.TextColor3 = Color_UI
                ...
                TextboxFrameOutline.BackgroundColor3 = Color_UI
                ...
                TextBox.BackgroundColor3 = Color_UI
                TextBox.BackgroundTransparency = 1.000
                TextBox.Position = UDim2.new(0.0178571437, 0, 0, 0)
                TextBox.Size = UDim2.new(0, 377, 0, 32)
                TextBox.Font = Enum.Font.Gotham
                TextBox.PlaceholderColor3 = Color_UI
                TextBox.PlaceholderText = placetext
                TextBox.Text = ""
                TextBox.TextColor3 = Color_UI
            ...
            function ChannelContent:Label(text)
                ...
                LabelTitle.TextColor3 = Color_UI
